# -*- coding: utf-8 -*-
"""
Created on Mon Feb  1 04:40:55 2021
...
class PolicyGradientAgent():
    ...
    def learn(self):
        ...
        # G_t = R_t+1 + gamma * R_t+2 + gamma * R_t+3
...
def plot_learning_curve(scores, x, figure_file):
    running_avg = np.zeroes(len(scores))
...
if __name__ == '__main__':
    ...
    fname = 'REINFORCE_' + 'lunar_lander_lr' + str(agent.lr) + '_' + str(n_games) + 'games'
